CLASS zcl_rap100_gen_data_lsv DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_lsv IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'lsv',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atravlsv.
*    DELETE FROM zrap100_dtravlsv.

    "insert travel demo data
    INSERT zrap100_atravlsv  FROM (
        SELECT
